...
- (main_firmware){programme/main_firmware] : Programme permettant d'effectuer la reconnaisse IA depuis la camera (Nécessite le modelè [m.kmodel](m.kmodel), il doit etre renomer en "m" et mis sur une SD)
